...
// =====================================================
// CARGA PUNTOS / GEOCERCAS DE UNA ZONA
// =====================================================
...
function getPoints(event, destination_id, zone_id) {
    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            drawExistingPolygons(resp, zone_id);
...
function initMap(destination_id = 1) {
    ...
    if (!defaultDestination) {
        ...
        Swal.fire({
            ...
            text: `El destino ID ${destination_id} no tiene coordenadas configuradas en zones.js.`
        });
...
function drawExistingPolygons(resp, zone_id) {
    ...
    for (const key in resp) {
        ...
        const polygonCoords = location.points.map(point => ({
