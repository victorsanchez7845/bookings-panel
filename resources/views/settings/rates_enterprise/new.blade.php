                ...
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                    <div class="section general-info">
                        <div class="info">
                            ...
                            <form
                                action="{{ !isset($rate)
                                    ? route('enterprises.rates.store', [
                                        isset($enterprise->id) ? $enterprise->id : 0
                                    ])
                                    : route('enterprises.rates.update', [
                            ...
                            >
                                ...
                                {{-- Campo anterior conservado temporalmente por compatibilidad --}}
                                <input
                                    type="hidden"
                                    name="operating_cost"
                                    value="{{ old(
                                                    ...
                                                    @foreach ($destinations as $destination)
                                                        <option
                                                            ...
                                                            {{
                                                                ...
                                                                && $rate->destination_id == $destination->id
                                                                    ? 'selected'
                                                                    : ''
                                                            }}
                                                        >
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                class="form-control"
                                                id="rateServicesID"
                                                data-code="{{ isset($rate->destination_service_id)
